        ...
        if 'selected_prompt' in st.session_state:
            ...
            function copyPromptContent() {
                ...
                try {
                    ...
                    button.innerHTML = '✅ 已成功复制';
                    setTimeout(() => {
                        button.innerHTML = '📋 复制到剪贴板';
                    }, 2000);
                } catch (err) {
                    const button = document.querySelector('button');
            ...
            <div style="margin-top: 1rem;">
                <button
                    ...
                    style="width:100%%;padding:0.75rem;border-radius:5px;border:1px solid #1f77b4;background-color:#ffffff;color:#1f77b4;cursor:pointer;transition:all 0.3s;font-size:1rem;"
